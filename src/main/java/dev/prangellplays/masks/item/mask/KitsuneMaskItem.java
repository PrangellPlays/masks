...
public class KitsuneMaskItem extends MaskItem {
    public KitsuneMaskItem(FabricItemSettings settings) {
        super(settings);
    }

    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("item.masks.kitsune_mask.desc").formatted(Formatting.DARK_GRAY));
